...
pin(grisp_base, spi1_pin9)  -> error({reserved, spi1_pin9});
pin(grisp_base, spi1_pin10) -> error({reserved, spi_pin10});
pin(grisp_base, ss1)        -> error({reserved, ss1});
pin(grisp_base, ss2)        -> error({reserved, sss2});
