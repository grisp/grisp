...
% mod
pin(grisp2, spi1_1)        -> #{path => <<"/pmod-spi\0">>,             property => <<"grisp,gpios\0">>, index => 0};
pin(grisp2, spi1_2)        -> #{path => <<"/pmod-spi\0">>,             property => <<"grisp,gpios\0">>, index => 1};
pin(grisp2, spi1_3)        -> #{path => <<"/pmod-spi\0">>,             property => <<"grisp,gpios\0">>, index => 2};
pin(grisp2, spi1_4)       -> #{path => <<"/pmod-spi\0">>,             property => <<"grisp,gpios\0">>, index => 3};
%uart sendod row (lower)
