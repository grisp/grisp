...
open_and_close_same_() ->
    OpenReply = grisp_pwm:open(gpio1_2, grisp_pwm:default_pwm_config(), <<128:16>>),
    ?assertMatch(ok, OpenReply),
    CloseReply = grisp_pwm:close(gpio1_2),
    ?assertMatch(ok, CloseReply),
    OpenReply2 = grisp_pwm:open(gpio1_2, grisp_pwm:default_pwm_config(), <<128:16>>),
    ?assertMatch(ok, OpenReply2).

open_and_close_several_() ->
    OpenReply = grisp_pwm:open(gpio1_2, grisp_pwm:default_pwm_config(), <<128:16>>),
    ?assertMatch(ok, OpenReply),
    OpenReply2 = grisp_pwm:open(gpio1_4, grisp_pwm:default_pwm_config(), <<128:16>>),
    ?assertMatch(ok, OpenReply2),
...
setting_sample_() ->
    ...
    ?assertMatch(ok, grisp_pwm:set_sample(gpio1_2, <<128:16>>)),
    ?assertMatch(ok, grisp_pwm:set_sample(gpio1_2, <<256:16>>)),
    ...
    ?assertMatch({error, sample_out_of_range}, grisp_pwm:set_sample(gpio1_2, <<257:16>>)),
    CloseReply = grisp_pwm:close(gpio1_2),
    ?assertMatch(ok, CloseReply).

non_existing_pin_() ->
    OpenReply = grisp_pwm:open(foobar, grisp_pwm:default_pwm_config(), <<128:16>>),
...
conflicting_pins_() ->
    OpenReply = grisp_pwm:open(gpio1_4, grisp_pwm:default_pwm_config(), <<128:16>>),
    ?assertMatch(ok, OpenReply),
    OpenReply2 = grisp_pwm:open(gpio1_8, grisp_pwm:default_pwm_config(), <<128:16>>),
